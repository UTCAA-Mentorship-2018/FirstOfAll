...
# =============================================================================
#   Loading and copying the data from the file
# =============================================================================
    print("Loading the data...")
    data_load = pd.read_csv(datafile)
...
# =============================================================================
    data_update = drop_duplications(df)
...
# =============================================================================
    ...
    for i in range(len(UpdatedData)):
        ...
        pd.DataFrame(df).update(MissingData)
...
# =============================================================================
    ...
    print('Starting to separate data in each datasets...')
    for sets in range(Length):
        ...
        print('The TARGET mean for Missing Observations of set ' + str(sets) + 'is: ' + str(Missing_Means))
        ...
        print('The TARGET mean for Non-Missing Observations of set ' + str(sets) + 'is: ' + str(NonMissing_Means))
...
# =============================================================================
    ...
    print(pd.DataFrame(Target_Means_Val))
